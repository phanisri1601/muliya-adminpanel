            ...
            <div className="branch-header">
              ...
              <div className="branch-actions">
                {branch.googleMapsUrl && (
                  <a href={branch.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="button outline small">
                    <MapPin size={16} />
                    Get Directions
                  </a>
                )}

...
const initialCollections = [
  {
    id: 'COL-001',
    title: 'Amulya',
    description: 'Exquisite Amulya collection featuring timeless designs.',
    image: '/public/Amulya.jpg.jpeg',
    category: 'Gold',
    isActive: true,
    isFeatured: true,
    productCount: 24,
  ...
  },
  {
    id: 'COL-002',
    title: 'Mahathi',
    description: 'Elegant Mahathi collection with traditional craftsmanship.',
    image: '/public/Mahathi.png',
    category: 'Gold',
    isActive: true,
    isFeatured: true,
    productCount: 18,
  ...
  },
  {
    id: 'COL-003',
    title: 'Pouranik',
    description: 'Classic Pouranik collection with heritage designs.',
    image: '/public/Pouranik.png',
    category: 'Gold',
    isActive: true,
    isFeatured: false,
    productCount: 32,
  ...
  },
  {
    id: 'COL-004',
    title: 'Silveriya',
    description: 'Beautiful Silveriya collection with modern silver jewellery.',
    image: '/public/Silverio_2.png',
    category: 'Silver',
    isActive: true,
    isFeatured: true,
    productCount: 45,
  ...
  },
  {
    id: 'COL-005',
    title: 'Nithya',
    description: 'Eternal Nithya collection representing timeless beauty.',
    image: '/public/Nithiya.png',
    category: 'Gold',
    isActive: true,
    isFeatured: false,
    productCount: 12,
  ...
  },
  {
    id: 'COL-006',
    title: 'Mangalsutra',
    description: 'Sacred Mangalsutra collection for special occasions.',
    image: '/public/Mangalsutra.png',
    category: 'Bridal',
    isActive: true,
    isFeatured: true,
    productCount: 20,
